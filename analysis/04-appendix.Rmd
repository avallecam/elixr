...
paramALL <- readRDS("data/01-parameters.rds")

naMAT <- readRDS("data/02-out-of-bounce.rds")

triplMAT <- readRDS("data/02-triplicates.rds")
dupliMAT <- readRDS("data/02-duplicates.rds")
triplNEW <- readRDS("data/02-triplicates-filter.rds")
dupliNEW <- readRDS("data/02-duplicates-filter.rds")

Pf.ID <- readRDS("data/01-dilutions.rds")
```
