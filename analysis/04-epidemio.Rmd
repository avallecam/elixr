...
html(Hmisc::contents(unap6x), maxlevels=10, levelType='table')
```
...
haven::write_dta(unap6c %>% 
                   dplyr::rename(Ab_unit_Pfal=Ab.unit_Pfal,
                                 ...
                                 epi_n_redes_adquirio_dormir=epi_cantidad_redes_adquirio_dormir,
                                 epi_n_redes_usadas_actualmente=epi_cantidad_redes_usadas_actualmente)
                 , "data/04-epidemio-core.dta")
