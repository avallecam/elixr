...
- **02 typos** were corrected
- This experiment made **1937** observations for **969** ID's
- Among the **73** NA observations, **04** had an OD higher than the upper limit given by its STD.
- **63** observations had duplicates, **16** had triplicates.
- A unbiased selection criteria was used to filter replicates.
- Log transformed Ab.units shows a normal distribution.
- Outputs were stored in both tidy and untidy formats.
