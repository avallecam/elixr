...
* TO DO:
    ...
    - CHECK IF **ZG182-1** should be corrected to **ZG181-1**.
        ...
        + More detail in [Appendix C](#appendix-c-residual-na) **NOTE 2**.
...
More details in [Appendix C](#appendix-c-residual-na)
...
- For more detail, go to [Appendix C](#appendix-c-residual-na)
