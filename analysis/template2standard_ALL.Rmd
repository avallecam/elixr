...
```{r, fig.align='center', fig.width=8, fig.height=3, eval=TRUE}
#library(ggplot2)
#library(Rmisc)        #multiploting ggplots
...
Strings were split in the following way:
```{r}
...
for(i in 1:dim(deldobl)[1]) {
  deldoblMIX <- rbind(deldoblMIX,
                      finalDBcov[finalDBcov$id==strsplit(deldobl[i,], split = " ")[[1]][1],],
                      finalDBcov[finalDBcov$id==strsplit(deldobl[i,], split = " ")[[1]][3],])
}
