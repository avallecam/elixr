...
- A **QC report** shows 97.5% similarity for `microscopy` and 73.4% for `pcr`. Percentages increases assuming independent observations with regard to the `specie`.
...
A plot showing How `age` updating changed with respect to the patient `Ab.units` is in the [APPENDIX](#appendix-age-vs-ab-unit)
