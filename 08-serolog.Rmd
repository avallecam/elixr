...
stargazer::stargazer(mod1, mod2,
          ...
          #column.labels=c("All", "After backward elimination"), 
          title="Multivariate models for malaria specie-specific exposure",
          notes = "(1) All covariates. (2) After backward elimination.",
          add.lines = list(c("Events",
                        summary(mod1$model$exposure_viv)[2],
                        summary(mod2$model$exposure_viv)[2]
                        )),
          covariate.labels = c("Sex Female:Male",
                               "Age (17,36]:(8,17]",
                               "Age (36,85]:(8,17]",
...
stargazer::stargazer(mod1, mod2,
          ...
          notes = "(1) All covariates. (2) After backward elimination.",
          add.lines = list(c("Events",
                        summary(mod1$model$exposure_fal)[2],
                        summary(mod2$model$exposure_fal)[2]
                        )),
          covariate.labels = c("Sex Female:Male",
                               "Age (17,36]:(8,17]",
                               "Age (36,85]:(8,17]",
